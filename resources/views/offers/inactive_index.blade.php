        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">In Active Offers</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="row">
                    @hasrole('admin|issuer')
                        <div class="col-xl-12 text-right" style="text-align:right;margin-bottom:20px;">
                            <a href="{{ route('offers.create') }}" class="btn btn-primary btn-sm btn-square no-radius"> Create New Offer</a>
                        </div>
                    @endhasrole
                                        ...
                                        @hasrole('admin|issuer')
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 text-left">
                                                    <button class="btn badge py-3 px-4 fs-7 badge-light-danger deleteOffer no-radius text-danger" data-id="{{ $offer->id }}">
