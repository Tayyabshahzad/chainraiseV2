    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <div id="kt_app_header" class="app-header"
                @hasrole('investor') style="margin-left:-21em!important"  @endhasrole>
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                                    ...
                                    @if (Auth::user()->getFirstMediaUrl('profile_photo', 'thumb'))
                                        <img src="{{ Auth::user()->getFirstMediaUrl('profile_photo', 'thumb') }}"
                                            alt="user" />
                                    @else
            ...
            <!-- remove Nav   --->
            <div class="@hasrole('admin|issuer')  app-wrapper flex-column flex-row-fluid @endhasrole "
                id="kt_app_wrapper">
                <!--begin::Sidebar-->
                ...
                <div class="app-main flex-column flex-row-fluid "
                    @hasrole('investor')  style="margin-top:5em" @endhasrole id="kt_app_main">
                    ...
                    <div id="kt_app_footer" class="app-footer">
                        ...
                        <div
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="# " target="_blank" class="text-gray-800 text-hover-primary">Sublime
                                    Solutions</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Menu-->
