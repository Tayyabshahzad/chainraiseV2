...
<html lang="en">
	...
	<head><base href="../"/>
		...
		<link href="{{ env('APP_URL') . '/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_app_body" data-kt-app-layout="light-header" data-kt-app-header-fixed="true" data-kt-app-toolbar-enabled="true" class="app-default">
													...
													<div class="col-lg-6">
														...
														<div class="row">
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo1/dist/layouts/light-header.html" class="menu-link active">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
																		</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Light Header</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
											...
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_633f0a65864cd">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_633f0a65864cd" data-allow-clear="true">
																<option></option>
		...
		<script src="{{ env('APP_URL') . '/plugins/custom/fullcalendar/fullcalendar.bundle.js'}}"></script>
		...
		<script src="{{ env('APP_URL') . '/js/custom/widgets.js'}}"></script>
		<script src="{{ env('APP_URL') . '/js/custom/apps/chat/chat.js'}}"></script>
		<script src="{{ env('APP_URL') . '/js/custom/utilities/modals/upgrade-plan.js'}}"></script>
		<script src="{{ env('APP_URL') . '/js/custom/utilities/modals/create-app.js'}}"></script>
		<script src="{{ env('APP_URL') . '/js/custom/utilities/modals/users-search.js'}}"></script>
