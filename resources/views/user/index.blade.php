        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Listing
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-toolbar ">
                            ...
                            <div class="card-toolbar d-none show_on_multi_check">
                                <!--begin::Menu-->
                                <button class="btn btn-dark btn-sm no-radius btn-active-color-primary justify-content-end"
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                    ...
                                    <div class="menu-item px-3" data-kt-menu-trigger="hover"
                                        ...
                                        <!--begin::Menu item-->
                                        <a href="#" class="menu-link px-3" id="action-send-email"
                                        ...
                                        <div class="menu-sub menu-sub-dropdown w-185px py-4">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" id="action-upload-e-document"
                                                    ...
                                                    data-bs-target="#modal-quick-action-upload-e-document">
                                                    E Sign Document
                                                </a>
                                            </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('user.investor.create') }}" class="menu-link px-3"> Individual
                                        Investor </a>
                                </div>
                                <div class="menu-item px-3">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <tr class="odd">
                                                        <td class="ps-9">
                                                            <div
                                                                class="form-check form-check-sm form-check-custom form-check-solid me-4 me-lg-7">
                                                                <input class="form-check-input multi_select"
                                                    ...
                                                    @foreach ($users as $user)
                                                        <tr
                                                            class="odd @if ($user->status == 'inactive') bg-light-danger @endif">
                                                            <td class="ps-9">
                                                                <div
                                                                    class="form-check form-check-sm form-check-custom form-check-solid mt-3">
                                                                    <input class="form-check-input multi_select"
                                                                        name="user_check" type="checkbox"
                                                                        value="{{ $user->id }}">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <th class="ps-9">
                                                                <a href="#"
                                                                    class="btn btn-icon btn-color-muted btn-bg-light btn-active-color-primary btn-sm me-3 deleteUser"
