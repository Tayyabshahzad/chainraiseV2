...
<div class="container-fluid bg-dark-color  py-5">
    <div class="container">
        <div class="row ">
            <div class="col-lg-6 position-relative">
                <hr class="verticle-line-bar" style="width: 180px !important;">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-12 py-2">
                        <div class="row">
                            ...
                            <div class="col-9 d-flex align-items-center">
                                <h6>Sign up and create your investor profile</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 py-2 ">
                    ...
                    <div class="col-12 py-2">
                        <div class="row">
                            <div class="col-3 text-center">
                                <h1 class="second">03</h1>
                            </div>
                            <div class="col-9 d-flex align-items-center">
                                <h6>Connect a payment method</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 py-2">
                        <div class="row">
                            <div class="col-3 text-center">
                                <h1 class="second">04</h1>
                            </div>
                            <div class="col-9 d-flex align-items-center">
                                <h6>Browse the
                                    marketplace & invest</h6>
                            </div>
                        </div>
                    </div>
...
<div class="container-fluid bg-dark-color">
    <div class="row ">
        <div class="col-lg-12 text-center py-4">
            <h6>For Investors</h6>
            <h1 class="second">Frequently Asked Questions</h1>
        </div>
    </div>
                ...
                <div class="accordion" id="accordionFlushExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">If you’re over 18, you can invest with us! (If you’re younger,
                                    good for you for
                                    ...
                                    they can invest in your name.) The SEC <a
                                        ...
                                        Bulletin</a>, linked here, will give you some additional information about
                                    how much money you can
                                    or should invest using platforms like ChainRaise. Because of the risks involved,
                                    there are some
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">For more than two hundred years investors have publicly traded
                                    stocks and bonds.
                                    But those types of investments have their limitations, leading investors to
                                    alternative securities
                                    for the purpose of generating income, diversifying portfolios, boosting returns,
                                    or raising funds
                                    for other projects.</p>
                                <p class="black-font">These alternatives include real estate, stock or membership
                                    units in
                                    privately-held businesses, private equity, commodities, venture capital,
                                    farmland/timberland,
                                    mineral rights, tax lien certificates, hedge funds, annuities, art and
                                    collectibles, or even wine
                                    collections or antique coins. In short, a multitude of investment options are
                                    available beyond the
                                    floor of the New York Stock Exchange.</p>
                                <p class="black-font">Why do people invest in alternative securities? Some of the
                                    most prevalent
                                    reasons include favorable economic conditions, less dependence on typical market
                                    fluctuations,
                                    leveraging specific knowledge or skills, tax advantages, illiquid investments,
                                    higher fees, and
                                    market volatility.</p>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapsefour" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body ">
                                <p class="black-font">
                                <p class="black-font">Title III limits how much you can invest each year – not only
                                    in any one
                                    company, or through any Funding Portal, but in all companies through all Funding
                                    Portals. These
                                    limits apply only to your investments under Title III (Regulation Crowdfunding).
                                    ChainRaise’ portal
                                    will calculate your annual investment limit based on your net worth and income.
                                    Investment limits
                                ...
                                <p class="black-font">If your annual income or net worth is less than $107,000, you
                                    may invest the
                                    greater of:</p>
                                ...
                                <p class="black-font">There are no investment limits for accredited investors.
                                    Once you are verified
                                    as an accredited investor, you are free to invest without limits.</p>
                                <p class="black-font">You and your spouse may choose to combine your incomes and
                                    assets to invest,
                                    in which case you will both be treated as a single investor when determining
                                    how much you can
                                    invest.</p>
                                </p>
                            </div>
                        ...
                        <div id="flush-collapsefive" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">To calculate your net worth, add up all of your assets and
                                    subtract all
                                    liabilities. For purposes of crowdfunding, the value of your primary residence
                                    is not included in
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapsesix" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">First, create and verify an account on the ChainRaise Portal.
                                    chainRaise may or
                                    may not ask for your proof of income to determine your investment limit. You can
                                    then browse
                                    listings and think about which offering to choose for your investment. You
                                    should strongly consider
                                    consulting a lawyer or professional advisor prior to investing to understand and
                                    assess any and all
                                    risks that come with a particular offering. You can then choose to invest in
                                    your selected offer(s)
                                    and pledge a dollar amount to the offer(s). By choosing to invest in an offer,
                                    you acknowledge the
                                    risks that come with investing on a Funding Portal and are able to afford losing
                                    your entire
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapse7" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">The SEC requires any amendment to an offering be reconfirmed
                                    with outstanding
                                    investment commitments within 5 business days; if an issuer fails to do so, or
                                    you as an investor
                                    fail to reconfirm your commitment, your commitment will be considered canceled.
                                    An issuer must also
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseeight" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">You can cancel an investment commitment at any time up to 48
                                    hours before the
                                    offering deadline. If you make an investment commitment within 48 hours before
                                    the offering
                                    deadline, you cannot cancel your investment even if you have just made your
                                    commitment.

                                    If you successfully cancel your commitment, ChainRaise will refund the
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseten" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">If an offering has more investors than needed or an issuing
                                    company reaches its
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseelev" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">A third-party credit rating is not required for issuers on the
                                    ChainRaise
                                    Portal. Investors, therefore, have little to no objective measures to gauge an
                                    issuing company’s
                                    creditworthiness. You are strongly advised to conduct due diligence prior to
                                    making an investment
                                    commitment and to consult with a professional advisor to understand and assess
                                    all the risks
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingtwe">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="flush-collapsetwe">
                        ...
                        <div id="flush-collapsetwe" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">Yes, unless your country’s regulations forbid you from doing
                                    so.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingthr">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#flush-collapsethr" aria-expanded="false"
                                aria-controls="flush-collapsethr">
                        ...
                        <div id="flush-collapsethr" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">It could be a short time, a long time, or never. Investing in
                                    issuing companies
                                    on a Funding Portal, especially startups, involves high amounts of risk.
                                    ChainRaise therefore
                                    strongly recommends investors consult with a professional advisor prior to
                                    making an investment
                                    commitment. You must understand and assess the risks involved with your
                                    investment. There is no
                                    guarantee any companies in which you invest will make a profit. You might lose
                                    your entire
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingforthteen">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#flush-collapseforthteen" aria-expanded="false"
                                aria-controls="flush-collapseforthteen">
                        ...
                        <div id="flush-collapseforthteen" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <p class="black-font">A fundraising round may close earlier than its published
                                    deadline on the
                                    offering. In this case, you will receive a notice of the new deadline at least 5
                                    business days prior
                                    to the new deadline. The SEC requires that if an issuing company fails to
                                    reconfirm investors’
                                    investment commitment within 5 business days of an offering’s changes, the
                                    investment commitment is
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                ...
                                a track record of revenue and income, the success of a startup or early-stage
                                venture often relies on
                                the development of a new product or service that may or may not find a market. You
                                should be able to
                                afford and be prepared to lose your entire investment.<p class="black-font">
                                    ...
                                    need to hold your
                                    investment for an indefinite period of time. Unlike investing in companies
                                    listed on a stock
                                    exchange where you can quickly and easily trade securities on a market, you may
                                    have to locate an
                                ...
                                <p class="black-font">Cancellation restrictions. Once you make an investment
                                    commitment for a
                                    crowdfunding offering, you will be committed to make that investment (unless you
                                    cancel your
                                    commitment within a specified period of time). As detailed in the box below for
                                    Changing your mind,
                                    the ability to cancel your commitment is limited.</p>
                                <p class="black-font">Valuation and capitalization. Your crowdfunding investment may
                                    purchase an
                                    equity stake in a startup. Unlike listed companies that are valued publicly
                                    through market-driven
                                    stock prices, the valuation of private companies, especially startups, is
                                    difficult and you may risk
                                    overpaying for the equity stake you receive. In addition, there may be
                                ...
                                <p class="black-font">Limited disclosure. The company must disclose information
                                    ...
                                    business plan, the offering, and its anticipated use of proceeds, among other
                                    things. An early-stage
                                    company may be able to provide only limited information about its business plan
                                    and operations
                                    because it does not have fully developed operations or a long history to provide
                                </p>
                            </div>
                        </div>
                    </div>
